...
PC 조립 시 **소켓/전원 규격이 자주 바뀌어** 소비자가 호환성을 스스로 판단하기 어렵고, 오판 시 **화재·성능 저하** 등 실질적 리스크로 이어진다는 데서 출발했습니다.

### 2. 객관적 근거

**기술 출처**

- **Intel 공식 지원 문서** — LGA1700 → LGA1851 소켓 세대 전환: 크기가 같아도 호환 불가
- **IT동아 뉴스줌인(2024.01.29)** — ATX 3.0 → 3.1 전환(1~2년 만), 12VHPWR → 12V-2x6 커넥터 세대 교체
- **Corsair 공식 가이드** — GPU별 권장 파워 용량(예: RTX 5090 1000W, RTX 5080 850W): TDP만 보면 과소·과대 산정 모두 위험
...
<details>
<summary>전체 브로셔 이미지 보기 (클릭)</summary>
