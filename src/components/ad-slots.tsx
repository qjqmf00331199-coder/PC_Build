export function AdSlots() {
  return (
    <>
      ...
      <div className="fixed inset-y-0 left-0 z-40 hidden w-48 items-center justify-end pr-6 2xl:flex">
        <img
          src="/ad-desktop.jpg"
          alt="광고"
      ...
      <div className="fixed inset-y-0 right-0 z-40 hidden w-48 items-center justify-start pl-6 2xl:flex">
        <img
          src="/ad-desktop.jpg"
          alt="광고"
          className="h-[600px] w-[160px] rounded-lg border border-[#27272A] bg-[#151517] object-contain"
      ...
      <div className="fixed inset-x-0 bottom-0 z-40 flex justify-center border-t border-[#27272A] bg-[#0A0A0B] py-1 lg:hidden">
        <img
          src="/ad-mobile.png"
          alt="광고"
