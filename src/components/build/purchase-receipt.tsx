  ...
  return (
    <div className="mt-4 border-t border-[#27272A] pt-4">
      ...
      {open && (
        ...
        >
          <div
            className="flex max-h-[85vh] w-full max-w-md flex-col rounded-t-xl border border-[#27272A] bg-[#151517] sm:rounded-xl"
          ...
          <div
            className={cn(
              "fixed inset-y-0 right-0 z-[60] flex w-[85vw] max-w-xs flex-col border-l border-[#27272A] bg-[#151517] shadow-2xl transition-transform duration-200 ease-in-out",
